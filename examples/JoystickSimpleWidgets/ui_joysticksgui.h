/********************************************************************************
** Form generated from reading UI file 'joysticksgui.ui'
**
...
#ifndef UI_JOYSTICKSGUI_H
#define UI_JOYSTICKSGUI_H
...
public:
    ...
    void setupUi(QDialog *JoysticksGui)
    {
        ...
        JoysticksGui->resize(279, 422);
        gridLayout = new QGridLayout(JoysticksGui);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        groupBox_5 = new QGroupBox(JoysticksGui);
        ...
        sizePolicy.setHeightForWidth(bar_axis_0->sizePolicy().hasHeightForWidth());
        bar_axis_0->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(bar_axis_1->sizePolicy().hasHeightForWidth());
        bar_axis_1->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(bar_axis_2->sizePolicy().hasHeightForWidth());
        bar_axis_2->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(bar_axis_3->sizePolicy().hasHeightForWidth());
        bar_axis_3->setSizePolicy(sizePolicy);
        ...
        log_layout->setObjectName(QStringLiteral("log_layout"));

        gridLayout->addLayout(log_layout, 4, 0, 1, 1);
        ...
        groupBox_4 = new QGroupBox(JoysticksGui);
